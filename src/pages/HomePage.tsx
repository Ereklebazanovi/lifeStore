...
const HomePage: React.FC = () => {
  ...
  const handleAddToCart = (product: any) => {
    // ღილაკი ისედაც გათიშულია თუ მარაგი 0-ია, მაგრამ მაინც ვამოწმებთ
    if (product.stock > 0) {
      addItem(product);
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-6 lg:gap-8 items-center !mt-7">
            <div className="space-y-4">
              ...
              <Link to="/products" className="inline-flex items-center gap-2 bg-emerald-600 hover:bg-emerald-700 text-white px-6 py-3 lg:px-8 lg:py-4 rounded-2xl transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-8">
              {products.slice(0, 8).map((product) => {
                ...
                return (
                  <div
                    key={product.id}
                    className="group bg-white rounded-xl lg:rounded-2xl border border-stone-200 overflow-hidden hover:shadow-xl hover:-translate-y-2 transition-all duration-300 relative"
                  >
                    ...
                    <div className="p-3 lg:p-5 space-y-2 lg:space-y-3">
                      ...
                      <Link to={`/product/${product.id}`}>
                        <h3 className="text-sm lg:text-base text-stone-900 tracking-tight line-clamp-1 hover:text-emerald-600 transition-colors">
                            {product.name}
                        </h3>
                      </Link>
                      ...
                      <div className="flex items-center justify-between pt-1 lg:pt-2">
                        ...
                        <button
                          ...
                          className={`w-9 h-9 lg:w-10 lg:h-10 rounded-lg lg:rounded-xl flex items-center justify-center transition-all duration-200 
                            ${isOutOfStock 
      ...
      <section className="py-12 lg:py-16 bg-gray-50 border-t border-gray-100">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex justify-center gap-6 lg:gap-8">
            <a href="https://www.facebook.com/lifestore.ge" target="_blank" rel="noopener noreferrer" className="group flex flex-col items-center transition-transform duration-300 hover:scale-105">
              ...
              <p className="mt-2 lg:mt-3 text-sm lg:text-base text-stone-700 transition-colors group-hover:text-blue-600">Facebook</p>
            </a>
            <a href="https://www.instagram.com/lifestore.ge" target="_blank" rel="noopener noreferrer" className="group flex flex-col items-center transition-transform duration-300 hover:scale-105">
              <div className="w-14 h-14 lg:w-16 lg:h-16 flex items-center justify-center rounded-full text-white shadow-xl transition-all duration-300" style={{ background: "radial-gradient(circle at 30% 107%, #fdf497 0%, #fdf497 5%, #fd5949 45%, #d6249f 60%, #285AEB 90%)" }}>
                <Instagram className="h-6 w-6 lg:h-7 lg:w-7" />
              </div>
              <p className="mt-2 lg:mt-3 text-sm lg:text-base text-stone-700 transition-colors group-hover:text-pink-600">Instagram</p>
            </a>
          </div>
        </div>
      </section>
