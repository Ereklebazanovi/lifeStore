    ...
    <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-sm">
      <div className="h-full flex items-center justify-center p-2 sm:p-4">
        <div className="bg-white rounded-2xl w-full max-w-7xl h-[95vh] shadow-2xl flex flex-col animate-in fade-in zoom-in duration-200">
          ...
          <div className="bg-gradient-to-r from-emerald-500 to-teal-600 p-6 rounded-t-2xl flex items-center justify-between text-white flex-shrink-0">
            <div>
              ...
              <p className="text-emerald-100 text-sm mt-1">სოციალური ქსელებიდან შემოსული შეკვეთების დამატება</p>
            </div>
            <button
              onClick={onClose}
        ...
        <div className="flex-1 flex overflow-hidden">
          <form id="create-order-form" onSubmit={handleSubmit} className="flex w-full h-full">
            ...
            <div className="flex-1 bg-gray-50 p-6 overflow-y-auto">
              <div className="space-y-6">
                ...
                <div className="bg-white rounded-xl p-4 shadow-sm border border-gray-200">
                  <h3 className="text-lg font-semibold text-gray-900 mb-4">შეკვეთის პარამეტრები</h3>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-2">წყარო</label>
                    ...
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-2">გადახდა</label>
                      <select
                        value={paymentMethod}
                ...
                <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
                  ...
                  <div className="space-y-4">
                    <div className="relative">
                      <ProductAutocomplete
                        value={items[0]?.name || ""}
                        onChange={(value) => handleItemChange(0, "name", value)}
                        onProductSelect={(selection) => handleProductSelect(0, selection)}
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                      {[
                        ...
                        <button
                          key={item.name}
                          type="button"
                          onClick={() => handleItemChange(0, "name", item.name)}
                ...
                {items.filter(item => item.name).length > 0 && (
                  <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
                    <h3 className="text-xl font-semibold text-gray-900 mb-4">კალათა</h3>
                                  ...
                                  if (availableStock <= 0) {
                                    ...
                                    return (
                                      <span className="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-emerald-100 text-emerald-800">
                                        ✅ ხელმისაწვდომია ({availableStock} ცალი)
                                      </span>
                                    );
                                  }
                                })()}
