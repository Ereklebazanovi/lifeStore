...
const AuthButton: React.FC = () => {
    ...
    return (
      <div className="flex items-center space-x-4">
        <div className="flex items-center space-x-2">
          ...
          {user.role === 'admin' && (
            <span className="px-2 py-1 text-xs bg-stone-800 text-white rounded">
              Admin
            </span>
          )}
        </div>
  ...
  return (
    <button
      ...
      className="flex items-center space-x-2 px-4 py-2 bg-white border border-stone-300 rounded-lg hover:bg-stone-50 transition-colors"
    >
