...
<body>
  ...
  <main>
    ...
    <h2>ჩვენი მისია: ნაკლები პლასტმასი, მეტი ჯანმრთელობა</h2>
    <p>
      ჩვენ არ ვყიდით უბრალოდ ნივთებს — ჩვენ ვქმნით გარემოს, სადაც თქვენ და
      თქვენი ოჯახის წევრები დაცულები ხართ ტოქსიკური ნივთიერებებისგან. ყოველი
      ნაბიჯი, რომელსაც ეკომეგობრული ალტერნატივებისკენ დგამთ, არის ინვესტიცია
      ჯანსაღ მომავალში.
    </p>
